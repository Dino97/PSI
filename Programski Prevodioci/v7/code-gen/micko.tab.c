...
#line 155 "micko.tab.c" /* yacc.c:355  */
};
...
#line 172 "micko.tab.c" /* yacc.c:358  */
...
{
       0,    56,    56,    68,    69,    74,    73,    98,   104,   106,
     116,   115,   124,   126,   129,   131,   135,   145,   156,   158,
     162,   163,   164,   165,   166,   170,   174,   190,   194,   207,
     209,   230,   232,   239,   245,   248,   252,   255,   261,   260,
     280,   282,   294,   297,   303,   308,   302,   322,   332
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_RBRACKET", "_ASSIGN", "_SEMICOLON", "_AROP", "_RELOP", "_INCR",
  "ONLY_IF", "$accept", "program", "function_list", "function", "$@1",
  "type", "parameter", "body", "$@2", "variable_list", "gvariable_list",
  "variable", "gvariable", "statement_list", "statement",
  "increment_statement", "increment", "compound_statement",
...
{
     -54,     9,    12,   -54,   -54,    12,   -54,    11,   -54,   -54,
      13,    10,   -54,   -54,    40,    12,    26,    41,   -54,    39,
     -54,   -54,    12,    46,   -54,   -54,    42,     4,   -54,    44,
      34,   -12,   -54,   -54,   -54,   -54,    43,   -54,   -54,   -54,
      50,   -54,   -54,    -5,   -54,   -54,    34,   -54,    23,   -54,
     -54,   -54,    34,   -54,    24,   -54,    28,    34,    49,     8,
     -54,    34,    30,   -54,   -54,    31,   -54,    34,   -54,   -54,
     -54,    34,    45,    47,    51,    47,    28,   -54,   -54
};
...
{
      14,     0,     0,     1,     7,     2,     3,     0,    15,     4,
       0,     5,     5,    17,     0,     8,     0,     0,     9,     0,
      12,     6,    10,     0,    18,    13,     0,     0,    16,     0,
       0,     0,    18,    11,    19,    24,     0,    20,    21,    22,
      42,    23,    44,    32,    36,    37,     0,    35,     0,    29,
      31,    33,     0,    26,     0,    25,     0,     0,     0,     0,
      48,     0,     0,    27,    43,     0,    45,    40,    34,    30,
      28,     0,     0,    41,     0,    47,     0,    39,    46
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -54,   -54,   -54,    55,   -54,    -1,   -54,   -54,   -54,   -54,
     -54,   -54,   -54,    29,   -53,   -54,   -27,   -54,   -54,   -45,
...
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     5,     6,    14,     7,    17,    21,    24,    22,
       2,    25,     8,    27,    34,    35,    47,    37,    38,    48,
      49,    50,    51,    58,    74,    39,    40,    57,    72,    66,
      41
};
...
{
      36,    59,    52,    64,    10,   -38,    53,    62,    29,     3,
      30,    31,    65,    53,    16,     4,    32,    33,    11,    68,
      12,    23,    73,    78,    61,    13,    75,    36,    29,    36,
      30,    31,    29,    18,    30,    31,    32,    63,    60,    61,
      32,    43,    44,    45,    46,    70,    61,    61,    71,    36,
      15,    20,    19,    26,    42,    56,    76,    28,    55,    67,
       9,    54,    77,    61,    69
};

static const yytype_uint8 yycheck[] =
{
      27,    46,    14,    56,     5,    10,    18,    52,     4,     0,
       6,     7,    57,    18,    15,     3,    12,    13,     7,    11,
       7,    22,    67,    76,    16,    15,    71,    54,     4,    56,
       6,     7,     4,     7,     6,     7,    12,    13,    15,    16,
      12,     7,     8,     9,    10,    15,    16,    16,    17,    76,
      10,    12,    11,     7,    10,     5,    11,    15,    15,    10,
       5,    32,    11,    16,    61
};
...
{
       0,    21,    30,     0,     3,    22,    23,    25,    32,    23,
      25,     7,     7,    15,    24,    10,    25,    26,     7,    11,
      12,    27,    29,    25,    28,    31,     7,    33,    15,     4,
       6,     7,    12,    13,    34,    35,    36,    37,    38,    45,
      46,    50,    10,     7,     8,     9,    10,    36,    39,    40,
      41,    42,    14,    18,    33,    15,     5,    47,    43,    39,
      15,    16,    39,    13,    34,    39,    49,    10,    11,    40,
      15,    17,    48,    39,    44,    39,    11,    11,    34
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,    20,    21,    22,    22,    24,    23,    25,    26,    26,
      28,    27,    29,    29,    30,    30,    31,    32,    33,    33,
      34,    34,    34,    34,    34,    35,    36,    37,    38,    39,
      39,    40,    40,    40,    40,    40,    41,    41,    43,    42,
      44,    44,    45,    45,    47,    48,    46,    49,    50
};
...
#line 1322 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 146 "micko.y" /* yacc.c:1646  */
    {
			if(lookup_symbol((yyvsp[-1].s), GVAR) == -1)
