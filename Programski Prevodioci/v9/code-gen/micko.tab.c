...
{
       0,    65,    65,    77,    78,    83,    82,   107,   113,   115,
     125,   124,   133,   135,   139,   148,   150,   154,   155,   156,
     157,   158,   159,   163,   167,   181,   198,   180,   225,   237,
     224,   260,   261,   266,   265,   285,   289,   288,   299,   301,
     308,   310,   331,   333,   340,   346,   351,   354,   360,   359,
     379,   381,   393,   396,   402,   407,   401,   421,   431
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_RBRACKET", "_ASSIGN", "_SEMICOLON", "_AROP", "_RELOP", "_FOR", "_INCR",
  "_SWITCH", "_CASE", "_DEFAULT", "_BREAK", "_COLON", "ONLY_IF", "$accept",
  "program", "function_list", "function", "$@1", "type", "parameter",
  "body", "$@2", "variable_list", "variable", "statement_list",
  "statement", "compound_statement", "assignment_statement",
  "for_statement", "@3", "$@4", "switch_statement", "@5", "$@6",
  "case_list", "case", "$@7", "default", "$@8", "break", "num_exp", "exp",
...
{
       0,   -58,     7,     0,   -58,     6,   -58,   -58,   -58,    13,
       0,    10,    29,   -58,    30,   -58,   -58,     0,    39,   -58,
     -58,    33,    -2,   -58,    48,    26,    43,   -58,   -58,    49,
      50,   -58,   -58,   -58,   -58,   -58,   -58,    56,   -58,   -58,
      52,   -58,   -58,    26,    23,   -58,   -58,   -58,    26,     2,
      57,    58,    25,    26,    53,    14,   -58,    26,    35,   -58,
      54,    55,   -58,    36,   -58,    26,   -58,   -58,   -58,    47,
     -58,    26,    59,    51,    60,    61,    62,    51,    25,   -58,
     -58,    63,   -58,    26,    47,    63,   -58,    64,    45,    65,
     -58,   -58,   -58,    66,    67,    68,    25,   -58,   -58,    69,
      70,    25,    71,    74,   -58,   -58,    25,   -58,   -58
};
...
{
       0,     7,     0,     2,     3,     0,     1,     4,     5,     0,
       8,     0,     0,     9,     0,    12,     6,    10,     0,    15,
      13,     0,     0,    14,     0,     0,     0,    15,    11,     0,
       0,    16,    17,    18,    21,    22,    19,    52,    20,    54,
      43,    46,    47,     0,     0,    40,    42,    44,     0,     0,
       0,     0,     0,     0,     0,     0,    58,     0,     0,    23,
       0,     0,    53,     0,    55,    50,    45,    41,    24,     0,
      28,     0,     0,    51,     0,     0,     0,    57,     0,    49,
      25,     0,    56,     0,     0,    29,    31,     0,     0,    35,
      32,    26,    33,     0,     0,     0,     0,    36,    30,     0,
      38,     0,     0,     0,    34,    37,     0,    39,    27
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -58,   -58,   -58,    75,   -58,    11,   -58,   -58,   -58,   -58,
     -58,    46,   -52,   -58,   -58,   -58,   -58,   -58,   -58,   -58,
     -58,   -58,   -13,   -58,   -58,   -58,   -58,   -24,    20,   -57,
     -58,   -58,   -58,   -58,   -58,   -58,   -58,     3,   -58
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     4,     9,     5,    12,    16,    19,    17,
      20,    22,    31,    32,    33,    34,    83,    95,    35,    76,
      89,    85,    86,    96,    94,   101,   104,    63,    45,    46,
      47,    54,    74,    36,    37,    53,    72,    64,    38
};
...
{
      62,    44,    24,     1,    25,    26,    24,     6,    25,    26,
      27,    28,    75,     8,    27,    59,    29,    13,    30,    55,
      29,    11,    30,    10,    58,    66,    82,    88,    18,    24,
      57,    25,    26,    40,    41,    42,    43,    27,    56,    57,
      14,    73,    15,    29,   100,    30,    21,    77,    23,   105,
      68,    57,    57,    71,   108,    41,    42,    48,    39,    50,
      51,    52,   -48,    65,    60,    61,    70,    57,    69,    92,
      78,    79,    90,    49,    81,    99,    80,    67,     7,    91,
      98,     0,   106,     0,    84,     0,    87,    93,   102,   107,
      97,     0,     0,   103
};

static const yytype_int8 yycheck[] =
{
      52,    25,     4,     3,     6,     7,     4,     0,     6,     7,
      12,    13,    69,     7,    12,    13,    18,     7,    20,    43,
      18,    10,    20,    10,    48,    11,    78,    84,    17,     4,
      16,     6,     7,     7,     8,     9,    10,    12,    15,    16,
      11,    65,    12,    18,    96,    20,     7,    71,    15,   101,
      15,    16,    16,    17,   106,     8,     9,    14,    10,    10,
      10,     5,    10,    10,     7,     7,    11,    16,    14,    24,
      11,    11,    85,    27,    12,     7,    15,    57,     3,    15,
      13,    -1,    11,    -1,    21,    -1,    83,    22,    19,    15,
      24,    -1,    -1,    23
};
...
{
       0,     3,    27,    28,    29,    31,     0,    29,     7,    30,
      10,    31,    32,     7,    11,    12,    33,    35,    31,    34,
      36,     7,    37,    15,     4,     6,     7,    12,    13,    18,
      20,    38,    39,    40,    41,    44,    59,    60,    64,    10,
       7,     8,     9,    10,    53,    54,    55,    56,    14,    37,
      10,    10,     5,    61,    57,    53,    15,    16,    53,    13,
       7,     7,    38,    53,    63,    10,    11,    54,    15,    14,
      11,    17,    62,    53,    58,    55,    45,    53,    11,    11,
      15,    12,    38,    42,    21,    47,    48,    63,    55,    46,
      48,    15,    24,    22,    50,    43,    49,    24,    13,     7,
      38,    51,    19,    23,    52,    38,    11,    15,    38
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,    26,    27,    28,    28,    30,    29,    31,    32,    32,
      34,    33,    35,    35,    36,    37,    37,    38,    38,    38,
      38,    38,    38,    39,    40,    42,    43,    41,    45,    46,
      44,    47,    47,    49,    48,    50,    51,    50,    52,    52,
      53,    53,    54,    54,    54,    54,    55,    55,    57,    56,
      58,    58,    59,    59,    61,    62,    60,    63,    64
};
...
static const yytype_uint8 yyr2[] =
{
       0,     2,     1,     1,     2,     0,     7,     1,     0,     2,
       0,     5,     0,     2,     3,     0,     2,     1,     1,     1,
       1,     1,     1,     3,     4,     0,     0,    14,     0,     0,
      10,     1,     2,     0,     6,     0,     0,     4,     0,     2,
       1,     3,     1,     1,     1,     3,     1,     1,     0,     5,
       0,     1,     1,     3,     0,     0,     7,     3,     3
};
...
#line 1335 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 1365 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 181 "micko.y" /* yacc.c:1646  */
    {
			...
			if(idx == -1)
				err("%s undefined", (yyvsp[-3].s));
				
			if(get_type(idx) != get_type((yyvsp[-1].i)))
				err("%s and %d are not of the same type", (yyvsp[-3].s), (yyvsp[-1].i));
...
#line 1442 "micko.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 198 "micko.y" /* yacc.c:1646  */
    {
			code("\n\t\t\t%s\t@for_statement%d", get_jump_stmt((yyvsp[-1].i), FALSE), (yyvsp[-2].i));
			code("\n\t\t\tJMP\t\t@for_exit%d", (yyvsp[-2].i));
			gen_snlab("for_statement", (yyvsp[-2].i));
		}
...
#line 205 "micko.y" /* yacc.c:1646  */
    {
			...
			if(get_type(idx) != get_type((yyvsp[-9].i)))
				err("%s and %d are not of the same type", (yyvsp[-3].s), (yyvsp[-9].i));
			
			code("\n\t\t\t%s\t", get_arop_stmt(ADD, get_type(idx)));
			print_symbol(idx);
			code(",$1,");
			print_symbol(idx);
			code("\n\t\t\tJMP\t\t@for_condition%d", (yyvsp[-7].i));
			gen_snlab("for_exit", (yyvsp[-7].i));
		}
...
#line 266 "micko.y" /* yacc.c:1646  */
    {
			for(int i = 0; i < case_nums_pos; i++)
			{
				if(case_nums[i] == (yyvsp[-1].i))
					err("case %s already exists", get_name((yyvsp[-1].i)));
			}
		
			case_nums[case_nums_pos++] = (yyvsp[-1].i);
		
			char str[50];
			sprintf(str, "%d_case%s", lab_num, get_name((yyvsp[-1].i)));
