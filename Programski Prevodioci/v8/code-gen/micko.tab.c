...
#line 157 "micko.tab.c" /* yacc.c:355  */
};
...
#line 174 "micko.tab.c" /* yacc.c:358  */
...
{
       0,    59,    59,    71,    72,    77,    76,   101,   107,   109,
     119,   118,   127,   129,   133,   142,   144,   148,   149,   150,
     151,   155,   159,   172,   173,   174,   192,   213,   234,   254,
     263,   267,   269,   276,   282,   285,   289,   292,   298,   297,
     317,   319,   331,   334,   340,   345,   339,   358,   368
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_COLON", "_A", "ONLY_IF", "$accept", "program", "function_list",
  "function", "$@1", "type", "parameter", "body", "$@2", "variable_list",
  "variable", "statement_list", "statement", "compound_statement",
  "assignment_statement", "num_exp", "md_exp", "ternary", "ternary_exp",
...
{
       2,   -71,    20,     2,   -71,    11,   -71,   -71,   -71,    14,
       2,    40,    37,   -71,    38,   -71,   -71,     2,    42,   -71,
     -71,    36,     0,   -71,    43,     7,    41,   -71,   -71,   -71,
     -71,   -71,   -71,    47,   -71,   -71,    44,   -71,   -71,     7,
      18,   -71,   -71,    39,   -71,   -71,     7,    15,    25,     7,
      46,    19,    49,   -71,     7,     7,    26,   -71,   -71,    27,
     -71,     7,   -71,     7,    45,   -71,    39,   -71,   -71,    50,
      48,    51,    48,    31,    25,   -71,   -71,    52,   -71,   -71,
      31,   -71
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      13,     0,     0,    14,     0,     0,     0,    15,    11,    16,
      17,    18,    19,    42,    20,    44,    32,    36,    37,     0,
       0,    24,    35,    23,    31,    33,     0,     0,     0,     0,
       0,     0,     0,    48,     0,     0,     0,    21,    43,     0,
      45,    40,    34,     0,     0,    26,    25,    27,    22,     0,
      41,     0,    47,     0,     0,    39,    29,     0,    30,    46,
       0,    28
};
...
{
     -71,   -71,   -71,    54,   -71,    -8,   -71,   -71,   -71,   -71,
     -71,    53,   -48,   -71,   -71,   -38,     4,   -71,   -15,    -9,
     -70,   -71,   -71,   -71,   -71,   -71,   -71,   -71,    17,   -71
};
...
static const yytype_int8 yydefgoto[] =
{
      ...
      20,    22,    29,    30,    31,    40,    41,    42,    77,    43,
      44,    45,    50,    71,    32,    33,    49,    69,    52,    34
};
...
{
      58,    51,    11,    78,    24,     1,    25,    26,    56,    18,
      78,    59,    27,    28,    36,    37,    38,    39,     8,    24,
       6,    25,    26,    70,    10,    72,    79,    27,    57,    24,
      62,    25,    26,    53,    54,    54,    63,    27,    76,    37,
      38,    68,    54,    54,    63,    66,    67,    13,    14,    21,
      15,    23,    48,    35,   -38,    46,    61,     7,    65,    55,
      64,    74,    75,    73,    54,    81,    60,     0,     0,     0,
...
{
      48,    39,    10,    73,     4,     3,     6,     7,    46,    17,
      80,    49,    12,    13,     7,     8,     9,    10,     7,     4,
       0,     6,     7,    61,    10,    63,    74,    12,    13,     4,
      11,     6,     7,    15,    16,    16,    17,    12,     7,     8,
       9,    15,    16,    16,    17,    54,    55,     7,    11,     7,
      12,    15,     5,    10,    10,    14,    10,     3,    54,    20,
      11,    11,    11,    18,    16,    80,    49,    -1,    -1,    -1,
...
{
       0,     3,    23,    24,    25,    27,     0,    25,     7,    26,
      10,    27,    28,     7,    11,    12,    29,    31,    27,    30,
      32,     7,    33,    15,     4,     6,     7,    12,    13,    34,
      35,    36,    46,    47,    51,    10,     7,     8,     9,    10,
      37,    38,    39,    41,    42,    43,    14,    33,     5,    48,
      44,    37,    50,    15,    16,    20,    37,    13,    34,    37,
      50,    10,    11,    17,    11,    38,    41,    41,    15,    49,
      37,    45,    37,    18,    11,    11,     7,    40,    42,    34,
      19,    40
};
...
{
       0,    22,    23,    24,    24,    26,    25,    27,    28,    28,
      30,    29,    31,    31,    32,    33,    33,    34,    34,    34,
      34,    35,    36,    37,    37,    37,    37,    38,    39,    40,
      40,    41,    41,    41,    41,    41,    42,    42,    44,    43,
...
#line 1386 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 235 "micko.y" /* yacc.c:1646  */
    {
			if(get_type((yyvsp[-2].i)) != get_type((yyvsp[0].i)))
				err("invalid operand types");
				
			int reg = take_reg();
			
			code("\n\t\t\t%s\t@true%d", get_jump_stmt((yyvsp[-5].i), FALSE), ++lab_num);
...
#line 255 "micko.y" /* yacc.c:1646  */
    {
			...
			if(idx == -1)
          err("invalid lvalue '%s' in ternary operator", (yyvsp[0].s));
...
#line 1546 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 345 "micko.y" /* yacc.c:1646  */
    {
        code("\n\t\t\t%s\t@false%d", get_jump_stmt((yyvsp[0].i), TRUE), (yyvsp[-1].i));
